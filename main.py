...
load_dotenv()
IVASMS_EMAIL = os.getenv("himelmia8585@gmail.com")
IVASMS_PASSWORD = os.getenv("Shakib1l@")
BOT_TOKEN = os.getenv("8735605186:AAEKDTK_bM2LSMXrxk4fL1NUUzCTpbiKyx4")
CHAT_ID = os.getenv("-5198205067")
